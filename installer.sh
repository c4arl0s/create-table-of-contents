...
SOURCE_SCRIPT="${SCRIPT_DIR}/create-table-of-contents.sh"
TARGET_LINK="/usr/local/bin/create-table-of-contents"
...
echo "Run it with: create-table-of-contents <content-file>"
